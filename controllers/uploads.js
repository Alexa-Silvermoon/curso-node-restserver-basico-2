...
const mostrarImagen = async( req, res = response ) => {
    ...
    // console.log( modelo.img ); //imagen del producto que aparece en postman y el cmd
    ...
    if ( modelo.img ){
        ...
        if( fs.existsSync( pathImagen ) ){
            ...
            return res.sendFile( pathImagen ); //FIXME: siempre esta mostrando no-image.jpg
    ...
    // res.json({ msg: 'falta placeholder - mostrarImagen'}); //el producto no tiene imagen
